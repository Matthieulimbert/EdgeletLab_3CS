...
elseif Use_scenario == 0;    
  %% THEN WE DO NOT RUN AN EXISTING SCENARIO AND GIVE THE PARAMETERS MANUALLY:
    ...
    % Type of image :
%     type_image = 'line';
    type_image = 'golden-gate-cut_0001_2.png';
%     type_image = 'sin';
%     type_image = 'sin_am';


    % Maximum size of the path :
    maxLength = 7;                              % Calculates BP for lengths 1,...,maxLength
...
% threshold for the best paths. We consider the best path only if its cost is > t_s :
